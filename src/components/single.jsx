  ...
  return (
    <div className={className}>
      <div>
        ...
        <p className={css(Styles.p, Styles.lastP)}>If you'd like to contact me, tyler.reckart(at)gmail.com. Here's my <span className={css(Styles.span)}>PGP public key</span>.</p>
      </div>
    </div>
  );
};
