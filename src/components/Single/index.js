  ...
  return (
    <div className={className}>
      <div>
        ...
        <p className={css(Styles.p)}>Hi! I'm Tyler Reckart. I'm a <a href="https://github.com/tylerreckart" target="_blank">Software Engineer</a>, occasional <a href="https://dribbble.com/tylerreckart" target="_blank">designer</a>, overly passionate comic book collector, and mechanical watch enthusiast. Most of my work is concerned with front-end architecture, and I primarily program in JavaScript because of that. On the side, I like to tinker with language parsing in Haskell.</p>
        <p className={css(Styles.p)}>I've worked with agencies, as a freelancer and with a number of startups. Notably, <a href="http://qui.lt" target="_blank">Quilt</a>, <a href="http://tiphive.com/" target="_blank">TipHive</a>, and most recently <a href="https://boomtownroi.com/" target="_blank">BoomTown</a>, where I am building software that helps top real estate brokerages acquire leads and close more deals.</p>
